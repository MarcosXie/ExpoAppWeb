...
namespace UExpo.Repository.Migrations
{
    ...
    [Migration("20241024111721_adds-relationship-between-catalog-segment-and-calendar")]
    partial class addsrelationshipbetweencatalogsegmentandcalendar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UExpo.Domain.Dao.CatalogSegmentDao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("UExpo.Domain.Dao.CatalogSegmentDao", b =>
                {
                    b.HasOne("UExpo.Domain.Dao.CalendarDao", "Calendar")
                        .WithMany("CatalogSegments")
                        .HasForeignKey("CalendarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UExpo.Domain.Dao.CalendarSegmentDao", "CalendarSegment")
                        .WithMany("Catalogs")
                        .HasForeignKey("CalendarSegmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
