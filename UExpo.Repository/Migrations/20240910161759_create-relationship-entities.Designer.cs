...
namespace UExpo.Repository.Migrations
{
    ...
    [Migration("20240910161759_create-relationship-entities")]
    partial class createrelationshipentities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UExpo.Domain.Dao.RelationshipChatDao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasKey("Id")
                        .HasName("relationship_chat_pkey");

                    b.HasIndex("BuyerUserId");

                    b.HasIndex("SupplierUserId");

                    b.ToTable("relationship_chat", (string)null);
                });
            ...
            modelBuilder.Entity("UExpo.Domain.Dao.RelationshipChatDao", b =>
                {
                    b.HasOne("UExpo.Domain.Dao.UserDao", "Buyer")
                        .WithMany("BuyerChats")
                        .HasForeignKey("BuyerUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UExpo.Domain.Dao.UserDao", "Supplier")
                        .WithMany("SupplierChats")
            ...
            modelBuilder.Entity("UExpo.Domain.Dao.RelationshipMessageDao", b =>
                {
                    b.HasOne("UExpo.Domain.Dao.RelationshipChatDao", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
