...
namespace ExpoApp.Repository.Migrations
{
    ...
    [Migration("20250820191142_adds-expired-date-into-code")]
    partial class addsexpireddateintocode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.CallCenterMessageDao", b =>
                {
                    ...
                    b.Property<bool>("ForceOriginalLanguage")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.GroupDao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.GroupMessageDao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.GroupUserDao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.RelationshipDao", b =>
                {
                    ...
                    b.Property<string>("BuyerEnterpriseNickName")
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("SupplierEnterpriseNickName")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.UserCalendarExpoDao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.UserLoroDao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<DateTime?>("ValidationCodeExpireDate")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("ExpoApp.Domain.Dao.MomentoDao", b =>
                {
                    b.HasOne("ExpoShared.Domain.Dao.UserDao", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.GroupDao", b =>
                {
                    b.HasOne("ExpoShared.Domain.Dao.UserDao", null)
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.GroupMessageDao", b =>
                {
                    b.HasOne("ExpoShared.Domain.Dao.GroupDao", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExpoShared.Domain.Dao.GroupUserDao", b =>
                {
                    b.HasOne("ExpoShared.Domain.Dao.GroupDao", "GroupDao")
                        .WithMany("GroupUsers")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ExpoShared.Domain.Dao.UserDao", "UserDao")
                        .WithMany("Groups")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GroupDao");
